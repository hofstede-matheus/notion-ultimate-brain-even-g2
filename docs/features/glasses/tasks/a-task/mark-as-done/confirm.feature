...
Feature: Marking a task done
  ...
  A task can be completed from its contextual menu. It is confirmed first — there is no undo on
  the glasses — and it disappears from the list as soon as the change is saved.
